...
class GlobalFitModelWidget(GlobalFitModel, model.ModelWidget):
    ...
    @property
    def origin_fit(self) -> chisurf.core.fitting.fit.Fit:
        """The origin fit for a link."""
        ofNbr = self.origin_fit_number
        return self.fits[ofNbr]

    @property
    def origin_parameter(self) -> chisurf.core.fitting.parameter.FittingParameter:
    ...
    @property
    def target_fit(self) -> chisurf.core.fitting.fit.Fit:
    ...
    @property
    def target_parameter(self) -> chisurf.core.fitting.parameter.FittingParameter:
