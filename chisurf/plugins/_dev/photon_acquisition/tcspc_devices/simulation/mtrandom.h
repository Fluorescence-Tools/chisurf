...
public:
 ...
 MTrandoms ();
 MTrandoms& MTrandoms::operator = (const MTrandoms&);

 void seedMT(unsigned long);
 void seedMT(void);
 void init_by_array(unsigned long*, int);

 void GetState(unsigned long*, int&);
 void SetState(unsigned long*, int);

 double random_res53();

/* generates a random number on [0,0xffffffff]-interval */
unsigned long inline MTrandoms::randomUInt(void)
{
    unsigned long y;
...
long inline MTrandoms::randomInt(void)
{
    unsigned long y;
...
long inline MTrandoms::randomIntPlus(void)
{
    unsigned long y;
...
double inline MTrandoms::random0i1i(void)
{
    unsigned long y;
...
/* generates a random number on (0,1)-real-interval */
double inline MTrandoms::random0e1e(void)
{
    unsigned long y;
...
/* generates a random number on [0,1)-real-interval */
double inline MTrandoms::random0i1e(void)
{
    unsigned long y;
...
double inline MTrandoms::random4nrm(void)
{
    unsigned long y;
