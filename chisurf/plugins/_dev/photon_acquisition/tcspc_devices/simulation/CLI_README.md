...
Burbulator-based TCSPC simulation used by the `sm_acquisition` plugin.
...
```bash
python chisurf/plugins/sm_acquisition/tcspc_devices/simulation/simulation_cli.py config \
...
python chisurf/plugins/sm_acquisition/tcspc_devices/simulation/simulation_cli.py run \
