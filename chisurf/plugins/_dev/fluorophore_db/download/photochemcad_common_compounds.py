...
and populates the ChiSurf `spectra.db` via `SpectraDatabase`.
...
# Allow importing SpectraDatabase from the parent package
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
from chisurf.fio.mmcif.db import FluorophoreDatabase  # type: ignore
...
def import_photochemcad_common_compounds(db: SpectraDatabase, common_dir: Path):
