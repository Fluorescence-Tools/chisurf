...
def register_services(dispatcher: Any) -> None:
    ...
    dispatcher.register("fluorophores.list", handle_list_probes)
    dispatcher.register("fluorophores.get", handle_get_probe)
    dispatcher.register("fluorophores.approve", handle_approve_probe)
    dispatcher.register("fluorophores.reject", handle_reject_probe)
    dispatcher.register("fluorophores.set_quality", handle_set_probe_quality)
    dispatcher.register("fluorophores.import_reference_set", handle_import_reference_set)
    dispatcher.register("fluorophores.forster_radius.lookup", handle_lookup_forster_radius)
    dispatcher.register("fluorophores.ai_triage", handle_run_ai_triage)
    dispatcher.register("fluorophores.probe_types.list", handle_list_probe_types)
