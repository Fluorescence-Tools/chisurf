...
single-molecule experiments. Features include:
- Loading and displaying TTTR data as intensity traces
- Histogram analysis of photon counts
- Hidden Markov Model (HMM) analysis for state detection
- Dwell time analysis for kinetic information
- FRET efficiency calculation and state-specific distributions

Ideal for analyzing single-molecule FRET, blinking, or other dynamic processes 
that can be observed in fluorescence intensity traces.
"""
