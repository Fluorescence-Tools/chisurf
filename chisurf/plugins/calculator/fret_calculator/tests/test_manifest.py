...
class TestAPIModels:
    ...
    def test_fret_settings_round_trip(self) -> None:
        from chisurf.plugins.calculator.fret_calculator.api.models import FretSettings
    ...
    def test_fret_result_round_trip(self) -> None:
        from chisurf.plugins.calculator.fret_calculator.api.models import FretResult
    ...
    def test_homo_fret_settings_round_trip(self) -> None:
        from chisurf.plugins.calculator.fret_calculator.api.models import HomoFretSettings
