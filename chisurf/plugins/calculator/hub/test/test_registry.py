"""Headless tests for the Calculators hub registry (no Qt)."""
...
def test_default_calculators_nonempty_and_unique():
    entries = default_calculators()
    assert entries
...
def test_entries_point_at_importable_widgets():
    for entry in default_calculators():
...
def test_manifest_loads():
    ...
    assert manifest.id == "calculators"
