"""Serialization helpers for BVA settings and results."""
...
def settings_from_dict(cls: type[T], data: dict[str, Any]) -> T:
    """Create a settings dataclass from a JSON-compatible dictionary."""
