...
_FORMAT_VERSION = "1.0"
_FORMAT_VERSION_KEY = "FormatVersion"
_RESERVED = {_FORMAT_VERSION_KEY, "Distances", "Positions", "χ²"}
...
class FpsJsonModel:
    ...
    def fps_json_payload(self) -> dict:
        ...
        p = {_FORMAT_VERSION_KEY: self.format_version}
        p.update(self.extra_sections)
    ...
    def fps_json_payload(self, payload: dict) -> None:
        ...
        if not isinstance(payload, dict):
            payload = {}
        self.format_version = str(payload.get(_FORMAT_VERSION_KEY, _FORMAT_VERSION))
    ...
    def add_distance(self, name: str, params: dict[str, Any], score_set: str | None = None) -> None:
