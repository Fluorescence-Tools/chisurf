...
// See mt19937cok.cpp.
// Version 2010-07-30  (fixed for modern C++ compilers)
...
static const double f1 = 2.3283064365387E-010;
static const double f2 = 2.3283064370808E-010;
static const double sqrt2en = 3.994274348768903E-010;
...
public:
    ...
    unsigned long inline randomUInt(void)
    {
        unsigned long y;
    ...
    long inline randomIntPlus(void)
    {
        unsigned long y;
        if (--left == 0) next_state();
        y = *next++;
