...
class BHSPCCardSetupDialog(QDialog):
    ...
    def create_hardware_tab(self):
        ...
        self.simulation_checkbox.setChecked(True)  # Default to simulation
        self.simulation_checkbox.setToolTip("Enable simulation mode for testing without hardware")
    ...
    def set_simulation_mode(self, simulation):
        """Set the simulation mode checkbox."""
        self.simulation_checkbox.setChecked(simulation)

    def get_simulation_mode(self):
        """Get the simulation mode from the checkbox."""
        return self.simulation_checkbox.isChecked()
