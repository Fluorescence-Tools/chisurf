...
SCHEMAS = {
    ...
    "raw_data": [
        {"name": "raw_data_id", "label": "Raw Data ID", "type": "int", "readonly": True},
    ...
    "processing_run": [
        {"name": "processing_id", "label": "Processing ID", "type": "int", "readonly": True},
        {"name": "experiment_id", "label": "Experiment ID", "type": "str", "readonly": True},
    ...
    "processed_product": [
        {"name": "product_id", "label": "Product ID", "type": "int", "readonly": True},
        {"name": "processing_id", "label": "Processing Run ID", "type": "int", "readonly": True},
    ...
    "analysis": [
        {"name": "analysis_id", "label": "Analysis ID", "type": "int", "readonly": True},
        {"name": "experiment_id", "label": "Experiment ID", "type": "str", "readonly": True},
        {"name": "type", "label": "Type", "type": "str", "readonly": True},
