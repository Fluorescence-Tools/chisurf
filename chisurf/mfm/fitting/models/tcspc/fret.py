...
from tcspc import Lifetime, LifetimeWidget, LifetimeModelWidgetBase
...
class FRETModel(LifetimeModel):
    ...
    def __init__(self, fit, **kwargs):
        ...
        #kwargs['func_calc_fret'] = self.calc_fret_efficiency
        self.orientation_parameter = OrientationParameter()
        self.fret_parameters = kwargs.get('fret_parameters', FRETParameters(func_calc_fret=self.calc_fret_efficiency,
                                                                            **kwargs))
