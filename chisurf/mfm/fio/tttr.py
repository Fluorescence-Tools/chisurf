...
def spc2hdf(
    ...
    >>> h5 = mfm.fio.tttr.spc2hdf(spc_files, filename='test.h5', title='hGBP1_18D')
    >>> h5 = mfm.fio.photons.spc2hdf(spc_files, filename='test.h5', title='hGBP1_18D_2')
    >>> h5.close()
...
def read_header(
    ...
    >>> header = mfm.fio.photons.read_header(b, 'bh132')
    >>> print(header)
    ...
    if routine_name == 'bh132':
        MTclock, DataInvalid = mfm.fio.tttr.bh123_header(b)
    elif routine_name == 'iss':
        MTclock, DataInvalid = mfm.fio.tttr.iss_header(b)
    elif routine_name == 'ht3':
        MTclock, DataInvalid = mfm.fio.tttr.ht3_header(b)
    else:
