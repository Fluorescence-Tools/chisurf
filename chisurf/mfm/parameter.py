...
class FittingParameter(Parameter):
    ...
    def make_widget(self, **kwargs):
        ...
        return FittingParameterWidget(self, **kw)
...
class ParameterGroup(mfm.base.Base):
    ...
    def find_parameters(self, parameter_type=Parameter):
        ...
        ag = mfm.find_objects(self.__dict__.values(), ParameterGroup)
...
class ParameterGroupWidget(ParameterGroup, QtWidgets.QGroupBox):
...
class GlobalParameter(FittingParameter):
    ...
    def __init__(self, f, g, formula, **kwargs):
        ...
        args = [f, g, formula]
        super(GlobalParameter, self).__init__(*args, **kwargs)
        self.f, self.g = f, g
