...
METHOD_SCHEMAS = {
    ...
    "parameter.get": {
        "required_params": ["parameter_name"],
        "optional_params": ["fit_index", "fit_uid"],
        "result": "ParameterDetailResult",
        "events": [],
    },
    "parameter.set_value": {
        "required_params": ["parameter_name", "value"],
        "optional_params": ["fit_index", "fit_uid"],
        "result": "ActionResult",
        "events": ["parameter.changed"],
    },
    "parameter.set_fixed": {
        "required_params": ["parameter_name", "fixed"],
        "optional_params": ["fit_index", "fit_uid"],
        "result": "ActionResult",
        "events": ["parameter.changed"],
    },
    "parameter.set_bounds": {
        "required_params": ["parameter_name", "bounds"],
        "optional_params": ["fit_index", "fit_uid"],
        "result": "ActionResult",
        "events": ["parameter.changed"],
    },
    ...
    "parameter.link": {
        "required_params": ["parameter_name_1", "parameter_name_2"],
        "optional_params": ["fit_index_1", "fit_index_2"],
        "result": "ActionResult",
        "events": ["parameter.changed"],
    },
    "parameter.unlink": {
