...
class DiffusionSimulationParameter(
    chisurf.core.parameter.ParameterGroup
):
    ...
    def __init__(
        ...
        super().__init__()
        self.t_max = chisurf.core.parameter.Parameter(
            value=t_max,
            name='t-max'
        )
        self.t_step = chisurf.core.parameter.Parameter(
            value=t_step,
            name='t-step'
        )
...
class Dye(ParameterGroup):
    ...
    def dye_definition(self):
        ...
        return chisurf.core.structure.av.dye_definition[self.dye_name]
    ...
    def n_atoms(self):
        ...
        n_atoms = chisurf.core.structure.count_atoms(json_topology)
        return n_atoms
