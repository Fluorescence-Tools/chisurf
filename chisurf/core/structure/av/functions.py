...
try:
    ...
    HAS_OPENCL = False
fps_settings = chisurf.core.settings.cs_settings['fps']


def histogram_rda(
        av1: typing.Type[chisurf.core.structure.av.BasicAV],
        av2: typing.Type[chisurf.core.structure.av.BasicAV],
        **kwargs
) -> typing.Tuple[
    np.ndarray,
    np.ndarray
    ...
    """
    rda_axis = kwargs.get('rda_axis', chisurf.core.fluorescence.rda_axis)
...
def RDAMean(
        av1: chisurf.core.structure.av.BasicAV,
        av2: chisurf.core.structure.av.BasicAV,
        **kwargs
) -> float:
    ...
    >>> structure = chisurf.core.structure(pdb_filename)
    >>> av1 = chisurf.core.structure.av.AV(structure, residue_seq_number=72, atom_name='CB')
    >>> av2 = chisurf.core.structure.av.AV(structure, residue_seq_number=134, atom_name='CB')
    >>> chisurf.core.structure.av.functions.RDAMean(av1, av2)
    52.93390285282142
    """
    n_samples = kwargs.get('distance_samples', fps_settings['distance_samples'])
...
def widthRDA(
    ...
    >>> av1 = chisurf.core.structure.av.AV(structure, residue_seq_number=72, atom_name='CB')
    >>> av2 = chisurf.core.structure.av.AV(structure, residue_seq_number=134, atom_name='CB')
    >>> chisurf.core.structure.av.functions.widthRDA(av1, av2)
    52.93390285282142
    """
    n_samples = kwargs.get('distance_samples', fps_settings['distance_samples'])
    d = random_distances(av1.points, av2.points, n_samples)
...
def get_kQ_rC(atoms, **kwargs):
    ...
    """
    quencher_dict = kwargs.get('quencher', chisurf.core.common.quencher)
