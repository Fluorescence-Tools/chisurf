...
import chisurf.core.structure.label.functions
...
class LabelDistribution(abc.ABC):
    ...
    def save(
        ...
        if mode == 'dx':
            ...
            offset = (ng - 1) / 2 * dg
            chisurf.core.fio.structure.density.write_mrc(
                filename,
                density,
                self.origin - offset,
                nx, ny, nz,
    ...
    def get_fret_rate_constant_spectrum(
            self,
            av: chisurf.core.structure.label.LabelDistribution,
        ...
        p, rda_axis = chisurf.core.structure.label.functions.histogram_rda(
            dd1=self,
            dd2=av,
            n_samples=n_samples,
            rda_axis=rda_axis,
        ...
        return chisurf.core.fluorescence.decay.compute_fret_rate_constants(
            p_rda=p,
            rda_axis=rda_axis,
            **kwargs
        )
    ...
    def get_distance_between_mean_positions(
        ...
        56.96909
        """
        return chisurf.core.structure.label.functions.distance_between_mean_positions(
            self, av
        )
    ...
    def average_distance(
        ...
        59.714254803678024
        """
        return chisurf.core.structure.label.functions.average_distance(self, av, **kwargs)
    ...
    def standard_deviation_of_distances(
        ...
        10.276833684832678
        """
        return chisurf.core.structure.label.functions.standard_deviation_of_distances(self, av)
    ...
    def mean_fret_distance(
        ...
        57.778193205194526
        """
        return chisurf.core.structure.label.functions.mean_fret_distance(
            self,
            av,
            forster_radius
        )
    ...
    def get_distance_distribution(
        ...
        :py:meth:`chisurf.core.structure.label.av.functions.histogram_rda`
        ...
        """
        return chisurf.core.structure.label.functions.histogram_rda(
