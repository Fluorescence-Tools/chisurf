...
This module connects an :class:`~chisurf.core.mfdb.models.EntityDefinition` to its
...
:class:`~chisurf.core.mfdb.models.MutationDefinition` records (the standard PDBx
...
from chisurf.core.mfdb.models import MutationDefinition
