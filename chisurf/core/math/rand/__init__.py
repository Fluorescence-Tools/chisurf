...
def random_numbers(
    ...
    >>> y = chisurf.core.math.functions.distributions.normal_distribution(x, loc=4)
    >>> rn = chisurf.core.math.rand.random_numbers(axis=x, cdf=np.cumsum(y), n=10000000, norm_cdf=True)
