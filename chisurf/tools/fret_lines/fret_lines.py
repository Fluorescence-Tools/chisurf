...
class FRETLineGenerator(object):
    ...
    >>> import fitting.model.tcspc as m
    >>> from chisurf.tools.fret_lines import FRETLineGenerator
    >>> R1 = 80
    >>> R2 = 35
    ...
    def __init__(
        ...
        self.fit = fitting.fit.Fit()
        self._data_points = experiments.data.DataCurve(
            setup=None,
