...
class Experiment(mfm.base.Base):
    ...
    is associated with a list of model and a list of setups. The list of model and the list
    of setups determine the applicable model and loadable data-types respectively.
    """
