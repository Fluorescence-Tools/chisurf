...
class Kappa2Dist(QtGui.QWidget):
    ...
    def __init__(self, kappa2=0.667):
        ...
        ## Connections
        self.connect(self.pushButton, QtCore.SIGNAL("clicked()"), self.onUpdateHist)
        self.connect(self.doubleSpinBox_4, QtCore.SIGNAL("valueChanged(double)"), self.onUpdateRapp)
        self.hide()
