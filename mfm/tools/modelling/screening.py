...
class FPSScreenTrajectory(QtWidgets.QWidget):#(QtWidgets.QWidget, TrajectoryFile, Model):
    ...
    def onClusterClicked(self):
        ...
        if len(self.structures) > 0:
            ...
            dir = None
        results = mfm.structure.cluster.cluster(self.structures, criterion=criterion,
    ...
    def onLoadTableOnStructures(self):
        ...
        filename = mfm.widgets.get_filename('Save cluster table', 'CSV data files (*.csv)')
