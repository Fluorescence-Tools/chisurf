...
from mfm.experiments import settings, Setup
from mfm.fluorescence.tcspc import fitrange, weights
...
class HistogramTTTR(QtGui.QWidget):
    ...
    def __init__(self):
        ...
        self.connect(w.tcspcTTTR.tcspcTTTRWidget.pushButton, QtCore.SIGNAL('clicked()'), self.add_curve)
...
class TCSPCSetupTTTRWidget(QtGui.QWidget):
