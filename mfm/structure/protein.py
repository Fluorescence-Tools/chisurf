...
import math
import numpy as np
from mfm.math.linalg import _vector as v
...
from mfm.math.linalg import _vector as vector
    ...
    for rn in list(structure.residue_dict.values()):
        ...
        if rp is None:
            ...
            structure.coord_i[ai] = rn['CA']['i'], rn['N']['i'], 0, 0, \
                                    vector.norm3(rn['N']['coord'] - rn['CA']['coord']), 0.0, 0.0
            ai += 1
            structure.coord_i[ai] = rn['C']['i'], rn['CA']['i'], rn['N']['i'], 0, \
                                    vector.norm3(rn['CA']['coord'] - rn['C']['coord']), \
...
class ProteinBead(Structure):
    ...
    def calc_internal_coordinates(self):
        ...
        def internal_coordinates_bead(structure):
            ...
            coord_i[1] = rd[0]['CA']['i'], rd[1]['CA']['i'], 0, 0, v.norm3(
                rd[0]['CA']['coord'] - rd[1]['CA']['coord']), 0.0, 0.0
            coord_i[2] = rd[0]['CA']['i'], rd[1]['CA']['i'], rd[2]['CA']['i'], 0, v.norm3(
                rd[2]['CA']['coord'] - rd[1]['CA']['coord']), \
                         v.angle(rd[0]['CA']['coord'], rd[1]['CA']['coord'], rd[2]['CA']['coord']), \
                         0.0
