...
class PDDEMWidget(QtGui.QWidget, PDDEM):
    ...
    def __init__(self, **kwargs):
        ...
        l = QtGui.QHBoxLayout()
        self._fAB = self._fAB.widget(layout=l, text='A>B')
        self._fBA = self._fBA.widget(layout=l, text='B>A')
        self.verticalLayout_3.addLayout(l)

        l = QtGui.QHBoxLayout()
        self._pA = self._pA.widget(layout=l)
        self._pB = self._pB.widget(layout=l)
        self.verticalLayout_3.addLayout(l)

        l = QtGui.QHBoxLayout()
        self._pxA = self._pxA.widget(layout=l, text='Ex<sub>A</sub>')
        self._pxB = self._pxB.widget(layout=l, text='Ex<sub>B</sub>')
        self.verticalLayout_3.addLayout(l)

        l = QtGui.QHBoxLayout()
        self._pmA = self._pmA.widget(layout=l, text='Em<sub>A</sub>')
        self._pmB = self._pmB.widget(layout=l, text='Em<sub>B</sub>')
        self.verticalLayout_3.addLayout(l)
