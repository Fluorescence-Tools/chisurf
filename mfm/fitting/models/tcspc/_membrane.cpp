...
static const char __pyx_k_a_z[] = "a_z";
static const char __pyx_k_d_x[] = "d_x";
static const char __pyx_k_d_y[] = "d_y";
static const char __pyx_k_d_z[] = "d_z";
...
static const char __pyx_k_d_rates[] = "d_rates";
...
static const char __pyx_k_calculate_rates[] = "calculate_rates";
...
static const char __pyx_k_C_Users_peulen_OneDrive_Programm[] = "C:\\Users\\peulen\\OneDrive\\Programming\\ChiSurf\\mfm\\fitting\\models\\tcspc\\_membrane.pyx";
...
static const char __pyx_k_mfm_fitting_models_tcspc__membra[] = "mfm.fitting.models.tcspc._membrane";
...
/* "mfm/fitting/models/tcspc/_membrane.pyx":12
...
static PyObject *__pyx_pw_3mfm_7fitting_6models_5tcspc_9_membrane_1calculate_rates(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("calculate_rates (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_tau0)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("calculate_rates", 1, 5, 5, 1); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_donors)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_rates", 1, 5, 5, 2); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_acceptors)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_rates", 1, 5, 5, 3); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_grid)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_rates", 1, 5, 5, 4); __PYX_ERR(0, 12, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "calculate_rates") < 0)) __PYX_ERR(0, 12, __pyx_L3_error)
      }
    ...
    __pyx_v_r0 = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_r0 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_tau0 = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_tau0 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_donors = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_int(values[2]); if (unlikely(!__pyx_v_donors.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_acceptors = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_int(values[3]); if (unlikely(!__pyx_v_acceptors.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_grid = __Pyx_PyObject_to_MemoryviewSlice_dsdsdsds_double(values[4]); if (unlikely(!__pyx_v_grid.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("calculate_rates", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 12, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_3mfm_7fitting_6models_5tcspc_9_membrane_calculate_rates(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_r0, double __pyx_v_tau0, __Pyx_memviewslice __pyx_v_donors, __Pyx_memviewslice __pyx_v_acceptors, __Pyx_memviewslice __pyx_v_grid) {
  unsigned int __pyx_v_n_donors;
  unsigned int __pyx_v_n_acceptors;
  ...
  /* "mfm/fitting/models/tcspc/_membrane.pyx":17
 ...
 */
  ...
  /* "mfm/fitting/models/tcspc/_membrane.pyx":18
 * 
 *     cdef unsigned int n_donors = donors.shape[0]
 *     cdef unsigned int n_acceptors = acceptors.shape[0]             # <<<<<<<<<<<<<<
 *     cdef unsigned int l, k
 ...
 */
  ...
  /* "mfm/fitting/models/tcspc/_membrane.pyx":24
 *     cdef double da
 * 
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_unsigned_int(__pyx_v_n_donors); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "mfm/fitting/models/tcspc/_membrane.pyx":26
 *     cdef np.ndarray[np.float64_t, ndim=1] d_rates = np.zeros(n_donors, dtype=np.float64)
 * 
 *     for l in prange(n_donors, nogil=True):             # <<<<<<<<<<<<<<
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            if (__pyx_t_9 > 0)
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_a_x) lastprivate(__pyx_v_a_y) lastprivate(__pyx_v_a_z) lastprivate(__pyx_v_d_x) lastprivate(__pyx_v_d_y) lastprivate(__pyx_v_d_z) lastprivate(__pyx_v_da) lastprivate(__pyx_v_k) firstprivate(__pyx_v_l) lastprivate(__pyx_v_l)
                    #endif /* _OPENMP */
                    for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_9; __pyx_t_8++){
                        {
                            __pyx_v_l = (unsigned int)(0 + 1 * __pyx_t_8);
                            /* Initialize private variables to invalid values */
                            __pyx_v_a_x = ((double)__PYX_NAN());
                            __pyx_v_a_y = ((double)__PYX_NAN());
                            __pyx_v_a_z = ((double)__PYX_NAN());
                            __pyx_v_d_x = ((double)__PYX_NAN());
                            __pyx_v_d_y = ((double)__PYX_NAN());
                            __pyx_v_d_z = ((double)__PYX_NAN());
                            __pyx_v_da = ((double)__PYX_NAN());
                            __pyx_v_k = ((unsigned int)0xbad0bad0);

                            /* "mfm/fitting/models/tcspc/_membrane.pyx":27
 * 
 *     for l in prange(n_donors, nogil=True):
 *         d_x = grid[donors[l, 0], donors[l, 1], donors[l, 2], 0]             # <<<<<<<<<<<<<<
 *         d_y = grid[donors[l, 0], donors[l, 1], donors[l, 2], 1]
 ...
 */
                            ...
                            __pyx_t_15 = 2;
                            __pyx_t_16 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_donors.data + __pyx_t_10 * __pyx_v_donors.strides[0]) ) + __pyx_t_11 * __pyx_v_donors.strides[1]) )));
                            __pyx_t_17 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_donors.data + __pyx_t_12 * __pyx_v_donors.strides[0]) ) + __pyx_t_13 * __pyx_v_donors.strides[1]) )));
                            __pyx_t_18 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_donors.data + __pyx_t_14 * __pyx_v_donors.strides[0]) ) + __pyx_t_15 * __pyx_v_donors.strides[1]) )));
                            __pyx_t_19 = 0;
                            ...
                            /* "mfm/fitting/models/tcspc/_membrane.pyx":28
 *     for l in prange(n_donors, nogil=True):
 *         d_x = grid[donors[l, 0], donors[l, 1], donors[l, 2], 0]
 *         d_y = grid[donors[l, 0], donors[l, 1], donors[l, 2], 1]             # <<<<<<<<<<<<<<
 *         d_z = grid[donors[l, 0], donors[l, 1], donors[l, 2], 2]
 ...
 */
                            ...
                            __pyx_t_25 = 2;
                            __pyx_t_26 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_donors.data + __pyx_t_20 * __pyx_v_donors.strides[0]) ) + __pyx_t_21 * __pyx_v_donors.strides[1]) )));
                            __pyx_t_27 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_donors.data + __pyx_t_22 * __pyx_v_donors.strides[0]) ) + __pyx_t_23 * __pyx_v_donors.strides[1]) )));
                            __pyx_t_28 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_donors.data + __pyx_t_24 * __pyx_v_donors.strides[0]) ) + __pyx_t_25 * __pyx_v_donors.strides[1]) )));
                            __pyx_t_29 = 1;
                            ...
                            /* "mfm/fitting/models/tcspc/_membrane.pyx":29
 *         d_x = grid[donors[l, 0], donors[l, 1], donors[l, 2], 0]
 *         d_y = grid[donors[l, 0], donors[l, 1], donors[l, 2], 1]
 *         d_z = grid[donors[l, 0], donors[l, 1], donors[l, 2], 2]             # <<<<<<<<<<<<<<
 *         for k in range(n_acceptors):
 ...
 */
                            ...
                            __pyx_t_35 = 2;
                            __pyx_t_36 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_donors.data + __pyx_t_30 * __pyx_v_donors.strides[0]) ) + __pyx_t_31 * __pyx_v_donors.strides[1]) )));
                            __pyx_t_37 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_donors.data + __pyx_t_32 * __pyx_v_donors.strides[0]) ) + __pyx_t_33 * __pyx_v_donors.strides[1]) )));
                            __pyx_t_38 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_donors.data + __pyx_t_34 * __pyx_v_donors.strides[0]) ) + __pyx_t_35 * __pyx_v_donors.strides[1]) )));
                            __pyx_t_39 = 2;
                            __pyx_v_d_z = (*((double *) ( /* dim=3 */ (( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grid.data + __pyx_t_36 * __pyx_v_grid.strides[0]) ) + __pyx_t_37 * __pyx_v_grid.strides[1]) ) + __pyx_t_38 * __pyx_v_grid.strides[2]) ) + __pyx_t_39 * __pyx_v_grid.strides[3]) )));

                            /* "mfm/fitting/models/tcspc/_membrane.pyx":30
 *         d_y = grid[donors[l, 0], donors[l, 1], donors[l, 2], 1]
 *         d_z = grid[donors[l, 0], donors[l, 1], donors[l, 2], 2]
 *         for k in range(n_acceptors):             # <<<<<<<<<<<<<<
 *             a_x = grid[acceptors[k, 0], acceptors[k, 1], acceptors[k, 2], 0]
 ...
 */
                            __pyx_t_40 = __pyx_v_n_acceptors;
                            for (__pyx_t_41 = 0; __pyx_t_41 < __pyx_t_40; __pyx_t_41+=1) {
                              __pyx_v_k = __pyx_t_41;

                              /* "mfm/fitting/models/tcspc/_membrane.pyx":31
 *         d_z = grid[donors[l, 0], donors[l, 1], donors[l, 2], 2]
 *         for k in range(n_acceptors):
 *             a_x = grid[acceptors[k, 0], acceptors[k, 1], acceptors[k, 2], 0]             # <<<<<<<<<<<<<<
 *             a_y = grid[acceptors[k, 0], acceptors[k, 1], acceptors[k, 2], 1]
 ...
 */
                              ...
                              __pyx_t_47 = 2;
                              __pyx_t_48 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_acceptors.data + __pyx_t_42 * __pyx_v_acceptors.strides[0]) ) + __pyx_t_43 * __pyx_v_acceptors.strides[1]) )));
                              __pyx_t_49 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_acceptors.data + __pyx_t_44 * __pyx_v_acceptors.strides[0]) ) + __pyx_t_45 * __pyx_v_acceptors.strides[1]) )));
                              __pyx_t_50 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_acceptors.data + __pyx_t_46 * __pyx_v_acceptors.strides[0]) ) + __pyx_t_47 * __pyx_v_acceptors.strides[1]) )));
                              __pyx_t_51 = 0;
                              __pyx_v_a_x = (*((double *) ( /* dim=3 */ (( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grid.data + __pyx_t_48 * __pyx_v_grid.strides[0]) ) + __pyx_t_49 * __pyx_v_grid.strides[1]) ) + __pyx_t_50 * __pyx_v_grid.strides[2]) ) + __pyx_t_51 * __pyx_v_grid.strides[3]) )));

                              /* "mfm/fitting/models/tcspc/_membrane.pyx":32
 *         for k in range(n_acceptors):
 *             a_x = grid[acceptors[k, 0], acceptors[k, 1], acceptors[k, 2], 0]
 *             a_y = grid[acceptors[k, 0], acceptors[k, 1], acceptors[k, 2], 1]             # <<<<<<<<<<<<<<
 *             a_z = grid[acceptors[k, 0], acceptors[k, 1], acceptors[k, 2], 2]
 ...
 */
                              ...
                              __pyx_t_57 = 2;
                              __pyx_t_58 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_acceptors.data + __pyx_t_52 * __pyx_v_acceptors.strides[0]) ) + __pyx_t_53 * __pyx_v_acceptors.strides[1]) )));
                              __pyx_t_59 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_acceptors.data + __pyx_t_54 * __pyx_v_acceptors.strides[0]) ) + __pyx_t_55 * __pyx_v_acceptors.strides[1]) )));
                              __pyx_t_60 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_acceptors.data + __pyx_t_56 * __pyx_v_acceptors.strides[0]) ) + __pyx_t_57 * __pyx_v_acceptors.strides[1]) )));
                              __pyx_t_61 = 1;
                              __pyx_v_a_y = (*((double *) ( /* dim=3 */ (( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grid.data + __pyx_t_58 * __pyx_v_grid.strides[0]) ) + __pyx_t_59 * __pyx_v_grid.strides[1]) ) + __pyx_t_60 * __pyx_v_grid.strides[2]) ) + __pyx_t_61 * __pyx_v_grid.strides[3]) )));

                              /* "mfm/fitting/models/tcspc/_membrane.pyx":33
 *             a_x = grid[acceptors[k, 0], acceptors[k, 1], acceptors[k, 2], 0]
 *             a_y = grid[acceptors[k, 0], acceptors[k, 1], acceptors[k, 2], 1]
 *             a_z = grid[acceptors[k, 0], acceptors[k, 1], acceptors[k, 2], 2]             # <<<<<<<<<<<<<<
 *             da = sqrt((d_x - a_x)**2 + (d_y - a_y)**2 + (d_z - a_z)**2)
 ...
 */
                              ...
                              __pyx_t_67 = 2;
                              __pyx_t_68 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_acceptors.data + __pyx_t_62 * __pyx_v_acceptors.strides[0]) ) + __pyx_t_63 * __pyx_v_acceptors.strides[1]) )));
                              __pyx_t_69 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_acceptors.data + __pyx_t_64 * __pyx_v_acceptors.strides[0]) ) + __pyx_t_65 * __pyx_v_acceptors.strides[1]) )));
                              __pyx_t_70 = (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_acceptors.data + __pyx_t_66 * __pyx_v_acceptors.strides[0]) ) + __pyx_t_67 * __pyx_v_acceptors.strides[1]) )));
                              __pyx_t_71 = 2;
                              __pyx_v_a_z = (*((double *) ( /* dim=3 */ (( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grid.data + __pyx_t_68 * __pyx_v_grid.strides[0]) ) + __pyx_t_69 * __pyx_v_grid.strides[1]) ) + __pyx_t_70 * __pyx_v_grid.strides[2]) ) + __pyx_t_71 * __pyx_v_grid.strides[3]) )));

                              /* "mfm/fitting/models/tcspc/_membrane.pyx":34
 *             a_y = grid[acceptors[k, 0], acceptors[k, 1], acceptors[k, 2], 1]
 *             a_z = grid[acceptors[k, 0], acceptors[k, 1], acceptors[k, 2], 2]
 *             da = sqrt((d_x - a_x)**2 + (d_y - a_y)**2 + (d_z - a_z)**2)             # <<<<<<<<<<<<<<
 *             d_rates[l] += 1./tau0 * (r0/da)**6
 *     return d_rates
 */
                              __pyx_v_da = sqrt(((pow((__pyx_v_d_x - __pyx_v_a_x), 2.0) + pow((__pyx_v_d_y - __pyx_v_a_y), 2.0)) + pow((__pyx_v_d_z - __pyx_v_a_z), 2.0)));

                              /* "mfm/fitting/models/tcspc/_membrane.pyx":35
 *             a_z = grid[acceptors[k, 0], acceptors[k, 1], acceptors[k, 2], 2]
 *             da = sqrt((d_x - a_x)**2 + (d_y - a_y)**2 + (d_z - a_z)**2)
 *             d_rates[l] += 1./tau0 * (r0/da)**6             # <<<<<<<<<<<<<<
 *     return d_rates
 */
                              ...
                              *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_d_rates.rcbuffer->pybuffer.buf, __pyx_t_72, __pyx_pybuffernd_d_rates.diminfo[0].strides) += ((1. / __pyx_v_tau0) * pow((__pyx_v_r0 / __pyx_v_da), 6.0));
                            }
                        }
                    }
                }
 ...
 */
  ...
  /* "mfm/fitting/models/tcspc/_membrane.pyx":36
 *             da = sqrt((d_x - a_x)**2 + (d_y - a_y)**2 + (d_z - a_z)**2)
 *             d_rates[l] += 1./tau0 * (r0/da)**6
 *     return d_rates             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_a_z, __pyx_k_a_z, sizeof(__pyx_k_a_z), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_d_z, __pyx_k_d_z, sizeof(__pyx_k_d_z), 0, 0, 1, 1},
 ...
 *     # donors: column, row, primitive
 */
  __pyx_tuple__20 = PyTuple_Pack(17, __pyx_n_s_r0, __pyx_n_s_tau0, __pyx_n_s_donors, __pyx_n_s_acceptors, __pyx_n_s_grid, __pyx_n_s_n_donors, __pyx_n_s_n_acceptors, __pyx_n_s_l, __pyx_n_s_k, __pyx_n_s_d_x, __pyx_n_s_d_y, __pyx_n_s_d_z, __pyx_n_s_a_x, __pyx_n_s_a_y, __pyx_n_s_a_z, __pyx_n_s_da, __pyx_n_s_d_rates); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(5, 0, 17, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_C_Users_peulen_OneDrive_Programm, __pyx_n_s_calculate_rates, 12, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 12, __pyx_L1_error)
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "mfm.fitting.models.tcspc._membrane")) {
      if (unlikely(PyDict_SetItemString(modules, "mfm.fitting.models.tcspc._membrane", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "mfm/fitting/models/tcspc/_membrane.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * cimport cython
 */
 ...
 *     # donors: column, row, primitive
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3mfm_7fitting_6models_5tcspc_9_membrane_1calculate_rates, NULL, __pyx_n_s_mfm_fitting_models_tcspc__membra); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_calculate_rates, __pyx_t_1) < 0) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
