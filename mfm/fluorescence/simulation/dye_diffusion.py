...
class DecaySimulationParameter(AggregatedParameters):
...
class DyeDecay(Curve):
    ...
    def get_photons(self, **kwargs):
        ...
        tau0 = kwargs.get('tau0', self.diffusion.dye.tau0)
...
class FRETDecay(DyeDecay):
    ...
    def get_donor_photons(self, **kwargs):
        kwargs['tau0'] = self.donor_diffusion.dye.tau0
