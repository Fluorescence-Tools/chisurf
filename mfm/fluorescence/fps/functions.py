...
def histogram_rda(
    ...
    """
    rda_axis = kwargs.get('rda_axis', mfm.fluorescence.rda_axis)
...
@nb.jit(nopython=True)
def assign_diffusion_to_grid_1(d_map, density, r0, dg, atoms_coord, min_distance_sq, atomic_slow_factor):
...
def assign_diffusion_to_grid_3(density, r0, dg, f):
