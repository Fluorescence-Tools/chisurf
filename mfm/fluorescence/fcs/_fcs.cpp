...
static const char __pyx_k_mfm_fluorescence_fcs__fcs[] = "mfm.fluorescence.fcs._fcs";
...
static const char __pyx_k_C_Users_peulen_OneDrive_Programm[] = "C:\\Users\\peulen\\OneDrive\\Programming\\ChiSurf\\mfm\\fluorescence\\fcs\\_fcs.pyx";
...
static PyObject *__pyx_pw_3mfm_12fluorescence_3fcs_4_fcs_1correlate(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("correlate (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_B)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("correlate", 1, 6, 6, 1); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_t)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("correlate", 1, 6, 6, 2); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_taus)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("correlate", 1, 6, 6, 3); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_corr)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("correlate", 1, 6, 6, 4); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_w)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("correlate", 1, 6, 6, 5); __PYX_ERR(0, 12, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "correlate") < 0)) __PYX_ERR(0, 12, __pyx_L3_error)
      }
    ...
    __pyx_v_n = __Pyx_PyInt_As_uint32_t(values[0]); if (unlikely((__pyx_v_n == (uint32_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_B = __Pyx_PyInt_As_uint32_t(values[1]); if (unlikely((__pyx_v_B == (uint32_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_t = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn_uint64_t(values[2]); if (unlikely(!__pyx_v_t.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_taus = __Pyx_PyObject_to_MemoryviewSlice_ds_nn_uint64_t(values[3]); if (unlikely(!__pyx_v_taus.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_corr = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[4]); if (unlikely(!__pyx_v_corr.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_w = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(values[5]); if (unlikely(!__pyx_v_w.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("correlate", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 12, __pyx_L3_error)
  __pyx_L3_error:;
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            if (__pyx_t_3 > 0)
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp for firstprivate(__pyx_v_b) lastprivate(__pyx_v_b) lastprivate(__pyx_v_ca) lastprivate(__pyx_v_ci) lastprivate(__pyx_v_j) lastprivate(__pyx_v_pa) lastprivate(__pyx_v_pi) lastprivate(__pyx_v_shift) lastprivate(__pyx_v_ta) lastprivate(__pyx_v_ti)
                    #endif /* _OPENMP */
                    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_3; __pyx_t_2++){
                        {
                            __pyx_v_b = (uint64_t)(0 + 1 * __pyx_t_2);
 ...
 *     cdef uint64_t ta, ti
 */
  __pyx_tuple__20 = PyTuple_Pack(16, __pyx_n_s_n, __pyx_n_s_B, __pyx_n_s_t, __pyx_n_s_taus, __pyx_n_s_corr, __pyx_n_s_w, __pyx_n_s_b, __pyx_n_s_pw, __pyx_n_s_ta, __pyx_n_s_ti, __pyx_n_s_ca, __pyx_n_s_ci, __pyx_n_s_pa, __pyx_n_s_pi, __pyx_n_s_shift, __pyx_n_s_j); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(6, 0, 16, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_C_Users_peulen_OneDrive_Programm, __pyx_n_s_correlate, 12, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 12, __pyx_L1_error)
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "mfm.fluorescence.fcs._fcs")) {
      if (unlikely(PyDict_SetItemString(modules, "mfm.fluorescence.fcs._fcs", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef uint64_t ta, ti
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3mfm_12fluorescence_3fcs_4_fcs_1correlate, NULL, __pyx_n_s_mfm_fluorescence_fcs__fcs); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_correlate, __pyx_t_1) < 0) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
