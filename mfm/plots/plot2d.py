...
class SurfacePlotWidget(QtGui.QWidget):
    def __init__(self, parent=None):
        ...
        self.connect(self.checkBox, QtCore.SIGNAL("stateChanged(int)"), self.parent.update_plots)
        self.connect(self.checkBox_2, QtCore.SIGNAL("stateChanged(int)"), self.parent.update_plots)
        self.connect(self.checkBox_3, QtCore.SIGNAL("stateChanged(int)"), self.parent.update_plots)
        self.connect(self.checkBox_4, QtCore.SIGNAL("stateChanged(int)"), self.parent.update_plots)

        self.connect(self.spinBox, QtCore.SIGNAL("valueChanged(QString)"), self.parent.update_plots)
        self.connect(self.spinBox_2, QtCore.SIGNAL("valueChanged(QString)"), self.parent.update_plots)
        self.connect(self.spinBox_3, QtCore.SIGNAL("valueChanged(QString)"), self.parent.update_plots)
        self.connect(self.spinBox_4, QtCore.SIGNAL("valueChanged(QString)"), self.parent.update_plots)
    ...
    def onAddSelection(self):
        ...
        cbe.connect(cbe, QtCore.SIGNAL("stateChanged(int)"), self.parent.update_plots)
