...
class ParameterScanWidget(QtGui.QWidget):
    def __init__(self, model, parent):
        ...
        self.connect(self.actionScanParameter, QtCore.SIGNAL('triggered()'), self.scan_parameter)
        self.connect(self.actionParameterChanged, QtCore.SIGNAL('triggered()'), self.onParameterChanged)
        self.connect(self.actionUpdateParameterList, QtCore.SIGNAL('triggered()'), self.update)
