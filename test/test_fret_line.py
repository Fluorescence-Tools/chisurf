...
class Tests(unittest.TestCase):
    ...
    def test_fret_line_1(self):
        ...
        self.assertEqual(
            ...
            '-0.010955047981697028*x^0+0.10789448086888817*x^1+0.49625194933924266*x^2+-0.0777791712551673*x^3+0'
            '.0024068639766969308*x^4'
        )
        self.assertEqual(
            fl.transfer_efficency_string,
            '1.0-(-0.010955047981697028*x^0+0.10789448086888817*x^1+0.49625194933924266*x^2+-0.0777791712551673*x^3+0'
            '.0024068639766969308*x^4)/(4.0)'
        )
        self.assertEqual(
            fl.fdfa_string,
            '0.8/0.32 / ((4.0)/(-0.010955047981697028*x^0+0.10789448086888817*x^1+0.49625194933924266*x^2+-0'
            '.0777791712551673*x^3+0.0024068639766969308*x^4) - 1)'
        )
