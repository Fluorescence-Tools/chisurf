...
_MODULE_PATH = Path(__file__).resolve().parents[1] / "chisurf" / "plugins" / "jordi_g_factor" / "__init__.py"
_SPEC = importlib.util.spec_from_file_location("chisurf_plugins_jordi_g_factor", _MODULE_PATH)
...
def test_estimate_lifetime_first_moment_returns_weighted_mean() -> None:
    ...
    # weighted mean around first positive bin (t0=1): ((0*2)+(1*2))/4 = 0.5
