...
parser.add_argument('ensemble_folder', metavar='file', type=str,
                    help='The folder containing PDB-files of the ensemble which is to be represented')

args = parser.parse_args()
print("Find structure best representing an ensemble")
print("============================================")
print("\tEnsemble folder: %s" % args.labeling_file)
print("")
