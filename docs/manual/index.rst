...
.. toctree::
   ...
   Computing Fluorescence Correlation Spectroscopy curves <computing_fluorescence_correlation_spectroscopy_curves>
   Data format <data_format>
   Provided test data - calibration <provided_test_data__calibration>
   Provided test data – live cell experiments <provided_test_data__live_cell_experiments>
   Provided test data – simulation <provided_test_data__simulation>
   ...
   Fit of a FCS curve <fit_of_a_fcs_curve>
   ...
   Fit of FCS curve <fit_of_fcs_curve>
   ...
   Determination of g-factor and depolarization factors using ChiSurf <determination_of_gfactor_and_depolarization_factors_using_chisurf>
   ...
   Re-using the parameter to analyse the actual samples <reusing_the_parameter_to_analyse_the_actual_samples>
