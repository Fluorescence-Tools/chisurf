...
if sys.argv[0].endswith('sphinx-build') and ('html' in sys.argv or sys.argv[-1] == '_build/html'):
    ...
    breathe_projects['chinet'] = './_build/xml'
    breathe_default_project = "chinet"
    extensions += ['breathe']
...
latex_documents = [
    (master_doc, 'chinet.tex', u'chinet Documentation', u'Thomas-Otavio Peulen', 'manual'),
]
